/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 46da036481c604162b65dc7a867ca208)
// Runtime types generated with workerd@1.20260811.1 2026-08-15 nodejs_als
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	API_BASE_URL: "https://boilerplate.cardtunic.cc";
	PROXY_API_ORIGIN: string;
	VITE_APP_ORIGIN: string;
	API: Fetcher /* boilerplate-api */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_BASE_URL" | "PROXY_API_ORIGIN" | "VITE_APP_ORIGIN">> {}
}
